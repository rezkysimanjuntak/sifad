            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Ganti Password Kepala Sekolah </h3>
                </div><!-- /.box-header -->
                ...
                <div class="box box-primary">   
                  ...
                  <div class="box-body no-padding">
                      <form id="formResetPassword" class="form-horizontal" role="form" method="POST" action="{{ route('reset.password.kepsek') }}">
