...
namespace App\Http\Controllers\RoleKepsek;
...
class RoleKepsekController extends Controller
{
   ...
   * @return Response
   */
  public function kepsekDashboard(Request $request)
  {
    
    $kepsekId = $request->get('kepsekNip');
    //registrasikan ke session
    $request->session()->set('IdKepsek', $kepsekId);
    $kepsekNip = $request->session()->get('kepsekNip');
...
//   }
  ...
  protected function formResetPasswordKepsek(){

    return view('kepsek.resetpasswordkepsek');
  }

  protected function resetPasswordKepsek(Request $request){
    ...
    return redirect()->route('kepsekdashboard');
  }
