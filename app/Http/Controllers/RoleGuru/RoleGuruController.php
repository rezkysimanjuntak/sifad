...
class RoleGuruController extends Controller
{
  ...
  public function guruDashboard(Request $request)
  {
    ...
    $guruId = $request->get('guruNip');
    //registrasikan ke session
    $request->session()->set('IdGuru', $guruId);
    $guruNip = $request->session()->get('guruNip');
...
//   }
  ...
  protected function formResetPasswordGuru(){

    return view('guru.resetpasswordguru');
  }

  protected function resetPasswordGuru(Request $request){
